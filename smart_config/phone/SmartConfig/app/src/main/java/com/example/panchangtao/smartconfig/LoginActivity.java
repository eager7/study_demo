package com.example.panchangtao.smartconfig;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            mtextView.setText("Start Search Thread");
            new SocketClientThread("Hello Server, I am Android Client").start();
        }
    }
